...
This repository documents my ongoing practice with data structures, algorithms, and technical interview preparation. Each solution includes an explanation of the approach, complexity analysis, and key concepts used.
...
- Day 8 → Valid Anagram
- Day 9 → Move Zeroes
- Day 10 → Is Subsequence
- Day 11 → Find Pivot Index
- Day 12 → Running Sum of 1D Array
- Day 13 → Longest Substring Without Repeating Characters
- Day 14 → Container With Most Water
- Day 15 → 3Sum
- Day 16 → Group Anagrams
- Day 17 → Min Stack
- Day 18 → Minimum Size Subarray Sum
- Day 19 → Product of Array Except Self
- Day 20 → Top K Frequent Elements
